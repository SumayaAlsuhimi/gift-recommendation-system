...
### [🚀 Open the live Giftly app](https://gift-recommendation-system-qd6x526czuix9ayv7pkif3.streamlit.app/)
...
| Service | URL |
|---|---|
| Streamlit interface | [Open Giftly](https://gift-recommendation-system-qd6x526czuix9ayv7pkif3.streamlit.app/) |
...
```bash
git clone https://github.com/ranatsa9/gift-recommendation-system.git
...
- Repository: `ranatsa9/gift-recommendation-system`
- Branch: `main`
